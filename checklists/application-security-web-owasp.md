...
Use before calling the [Project 9](../career-project-specs/09-application-security-lab.md) milestone **done**. This complements [integration-hardening.md](integration-hardening.md) (inbound integrations / webhooks)—here the focus is **browser, forms, sessions, and application SQL**.
