...
**Companion:** [docs README](../README.md) · [Phase 5 — Azure backends](../../career-project-specs/05-azure-backends.md) · [Language fundamentals — Go](language-fundamentals-comparison.md)

**Playbook role:** **Primary** language for high-concurrency workers, Service Bus consumers, and K8s-adjacent APIs (from Phase 5).
...
|----------|------------------|------------------|
| Queue consumers, retrieval gateway, strict latency/timeouts on chunk fetch | Python for LLM calls, eval harness, orchestration; Node/PHP for spec-named HTTP ingress | [Project 6](../../archive/v1-22-step/career-project-specs/06-async-worker-stretch.md), [Project 8](../../archive/v1-22-step/career-project-specs/08-go-retrieval-worker-lab.md), [Project 15 CLI](../../archive/v1-22-step/career-project-specs/15-devops-cli-lab.md) |
...
| Retrieval gateway, chunk fan-out | Project 8 | LLM/evals in Go (use [Project 2](../../archive/v1-22-step/career-project-specs/02-rag-llm-service.md)) |
...
- Queue consumers: **idempotency**, **dead-letter queue (DLQ)**, **max retries** aligned with [Project 6](../../archive/v1-22-step/career-project-specs/06-async-worker-stretch.md) semantics.
