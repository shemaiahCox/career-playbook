...
- **AI + automation + cloud (one spine)** — [Learning journey quick map](paths/learning-journey.md#ai-automation-and-cloud--quick-map) · [P4 RAG](../career-project-specs/04-rag-llm-service.md) · [P5 worker](../career-project-specs/05-async-worker-stretch.md) · [P9 Go](../career-project-specs/09-go-retrieval-worker-lab.md) · [integration-automation](stacks/integration-automation.md).
