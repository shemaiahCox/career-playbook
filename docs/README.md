...
- **Polyglot architecture / stack exploration** — [Systems architect across languages](paths/systems-architect-across-languages.md); [Language fundamentals comparison](handbook/language-fundamentals-comparison.md) (JS/PHP vs Go, Rust, C#, Java, Kotlin, Swift); [exploration sandboxes](../exploration-projects/README.md); [ecosystem maps](stacks/README.md#ecosystem-maps-optional-short); optional depth [Node + TS API](stacks/node-typescript-backend.md) · [Java / JVM](stacks/java-jvm.md) · [glossary](stacks/glossary.md).
