...
- **AI + LLM** — handbook [Large language models (LLMs)](handbook/llms.md); [Project 4: RAG / LLM service](../project-specs/04-rag-llm-service.md); checklist [LLM feature ship](../checklists/llm-feature-ship.md); workflow [AI-assisted unfamiliar stack](paths/ai-assisted-unfamiliar-stack.md) when the stack is new.
