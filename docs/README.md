...
- **[paths/](paths/)** — **Where am I going?** [Learning journey](paths/learning-journey.md), [Systems integration architect](paths/systems-integration-architect.md), [Algorithms study path](paths/algorithms-study-path.md), [AI-assisted unfamiliar stack](paths/ai-assisted-unfamiliar-stack.md).
