...
Guided **read and apply** path through [Algorithms and data structures](../handbook/algorithms-and-data-structures.md). This is **not optional** when you are in [Project 7](../../career-project-specs/07-sql-performance-lab.md), [Project 9](../../career-project-specs/09-go-retrieval-worker-lab.md), or building **chunk/retrieval pipelines** in [Project 4](../../career-project-specs/04-rag-llm-service.md).
...
**Read:** [Big-O is scaling, not seconds](../handbook/algorithms-and-data-structures.md#big-o-is-scaling-not-seconds) through [Reading loops](../handbook/algorithms-and-data-structures.md#reading-loops-practical).
...
**Read:** [Array, dynamic array, list](../handbook/algorithms-and-data-structures.md#array-dynamic-array-list-contiguous).
...
**Apply:** Idempotency key store; dedupe set for seen job IDs in P9 worker; JS `Map` for in-memory cache.
...
**Read:** Queue/stack sections if present; else [Built-in data structures — stack/queue](../handbook/language-fundamentals-comparison.md#stack-and-queue-idioms).

**Apply:** P5 worker drain; DLQ as secondary queue; Boomi “execution” as ordered steps.
...
**Read:** [Database design — Indexes](../handbook/database-design.md#indexes) alongside handbook tree/B-tree mentions.

**Apply:** P7 `EXPLAIN` before/after index; why B-tree index helps `WHERE id = ?` but not always `LIKE '%x%'`.
...
## Checklist before calling P7/P9 “done”
...
- [Language fundamentals — choosing structures](../handbook/language-fundamentals-comparison.md#choosing-at-a-glance)
- [Systems integration architect](systems-integration-architect.md)
- [Software engineering — Concurrency](../handbook/software-engineering.md#concurrency-basics)
