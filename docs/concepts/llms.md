...
**Do not confuse this page with workflows:** gate releases with **[LLM feature ship](../../checklists/llm-feature-ship.md)** and the lab contract in **[Project 2](../../career-project-specs/02-rag-llm-service.md)**.
...
- Return **identifiers** alongside answers (see **`cited_chunk_ids`** in [Project 2](../../career-project-specs/02-rag-llm-service.md)) so support and debugging trace “wrong answer” to “wrong retrieval” versus “generation drift.”
