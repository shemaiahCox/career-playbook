# Project 8 — OWASP / cybersecurity foundations (web application)
...
- **Complements P1:** [Project 1](01-integration-webhook-receiver.md) and [integration-hardening.md](../checklists/integration-hardening.md) cover **integration-edge** security (signatures, idempotency). P8 covers **browser + database + forms**—how most business apps actually behave.
...
| **Node + Express/Fastify + EJS/Pug** | Pairs with [Project 6](06-node-typescript-lab.md) if you want the same **language** as optional Node work. |

**Not gated on** [Project 2](02-contract-first-api.md): you may add **JSON endpoints** and OpenAPI later (optional **API Top 10** slice), but the **core** success criteria assume **HTML forms** and a **relational** store.

**Pairs with** [Project 7](07-sql-performance-lab.md): shared SQL engine discipline; P7 is about **plans and correctness under load**—P8 adds **injection** failure modes and **safe query** habits. Neither requires the other first.
...
Baseline **cybersecurity literacy** for application engineers, **secure SDLC** conversations, and safer **full-stack-adjacent** shipping—without replacing [Project 1](01-integration-webhook-receiver.md) integration-edge work.
