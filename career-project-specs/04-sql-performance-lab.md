# Project 4 — SQL performance and correctness lab
...
- Read query plans and fix missing indexes
...
- **Handbook:** [Database design — N+1](../docs/concepts/database-design.md#orms-and-the-n1-query-pattern) · [Memory and performance — DB slice](../docs/concepts/memory-and-performance.md#find-the-bottleneck)
...
| **Local sibling** | [`../career-projects/04-sql-perf-lab`](../career-projects/04-sql-perf-lab) |
...
Run order and setup: see [04-sql-perf-lab/README.md](../career-projects/04-sql-perf-lab/README.md).
...
The repo already ships scripted exercises—use these scenarios as **learning goals** (what you should see before moving on). Commands and seeds: [04-sql-perf-lab README](../career-projects/04-sql-perf-lab/README.md) and `exercises/*.sql`.
