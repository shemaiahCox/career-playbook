...
Run against [`04-rag-llm-lab`](../career-projects/04-rag-llm-lab) ([GitHub](https://github.com/shemaiahCox/rag-llm-lab)) locally; put API curls and env notes in that repo's README. Focus on **evals**, **response contract**, and **logs**—not chat UX polish.
